...
if [ -f ~/.config/myconf/aliasrc ]; then
    . ~/.config/myconf/aliasrc
fi
...
## The following should be separated into distince directories
# R Language
R_HOME_USER="$HOME/.config/R"
R_PROFILE_USER="$HOME/.config/R/profile"
R_HISTFILE="$HOME/.config/R/history"
export R_HOME_USER R_PROFILE_USER R_HISTFILE
